...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <section class="ftco-section">
        ...
        <?php 
								$projects = $usman_ngo->query("SELECT * FROM about_us");
								$row= $projects->fetch_array();
              
						?>
    			<div class="col-md-6 d-flex ftco-animate">
    				<div class="img img-about align-self-stretch" style="background-image: url(images/<?php echo ($row['image']) ?>); width: 100%;"></div>
    			</div>
    			<div class="col-md-6 pl-md-5 ftco-animate">
    				<h2 class="mb-4"><?php echo ucwords($row['title']) ?></h2>
