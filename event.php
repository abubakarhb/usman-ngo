  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <section class="ftco-section">
      <div class="container">
        ...
        <?php 
            $results_per_page = 6;
            $projects = $usman_ngo->query("SELECT * FROM event2");
            $total_results = $projects->num_rows;
              ...
              // Calculate the starting and ending result indices for the current page
              $start_index = ($current_page - 1) * $results_per_page;
              $end_index = $start_index + $results_per_page - 1;
              // Retrieve the results for the current page
              $projects = $usman_ngo->query("SELECT * FROM event2 LIMIT $start_index, $results_per_page");
        	...
        	<div class="col-md-4 d-flex ftco-animate">
              ...
              <div class="text p-4 d-block">
              	<div class="meta mb-3">
                  <div><a href="./event-single.php?eventid=<?php echo ucwords($row["id"]); ?>"><?php echo ucwords($row['date']) ?></a></div>
                ...
                <h3 class="heading mb-4"><a href="./event-single.php?eventid=<?php echo ucwords($row["id"]); ?>"><a href="#"><?php echo ucwords($row['header']) ?></a></h3>
            ...
            <div class="block-27">
              ...
              // Display the pagination links
                if ($total_pages > 1) {
                  echo "<br><br>";
                  if ($current_page > 1) {
                    echo "<li><a href='event.php?page=".($current_page - 1)."'>&lt;</a></li> ";
                  }
