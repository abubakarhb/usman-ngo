      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-7 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
             <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="index.php">Home</a></span> <span>Donations</span></p>
      ...
      <div class="container">
        ...
        <?php 
                $results_per_page = 6;
                  ...
                  $projects = $usman_ngo->query("SELECT * FROM projects LIMIT $start_index, $results_per_page");
            ...
            <div class="block-27">
              ...
              // Display the pagination links
                if ($total_pages > 1) {
                  echo "<br><br>";
                  if ($current_page > 1) {
                    echo "<li><a href='donate.php?page=".($current_page - 1)."'>&lt;</a></li> ";
                  }
                  for ($i = 1; $i <= $total_pages; $i++) {
                    if ($i == $current_page) {
                      echo "<li><a><strong>".$i."</strong></a></li> ";
                    } else {
                      echo "<li><a href='donate.php?page=" .$i. "'>" .$i."</a></li>";
                    }
                  }
