...
if (isset($_POST['submit1'])) {
  ...
  $subject = mysqli_real_escape_string($usman_ngo, $_POST['subject']);
  ...
  //  print_r($name);die;
  $query = sprintf("INSERT INTO `contact_us`( `name`, `email`, `subject`, `msg`) VALUES('$name','$email','$subject','$message')");
    //    print_r($query);die;
  ...
  if ($User_re) {
    ...
    try {
      ...
      $body = '<p> <strong>' . $name .' '. 'Sent </strong> ' . $message . '</p>';
