...
if (isset($_POST['submit2'])) {
  $blog_id = mysqli_real_escape_string($usman_ngo, $_POST['project_id']);
...
// echo $blog_id; die;
  ...
  if (empty($_POST['name']) || empty($_POST['email']) || empty($_POST['message'])) {
    ...
    echo "<script>window.location.href='./blog-single.php?blogid=" . $blog_id . "';</script>";
  }
  // echo $blog_id; die;

  $query = sprintf("INSERT INTO `blog_comment`(`blog_id`, `name`, `email`, `website`, `message`) VALUES ('$blog_id','$name','$email','$website','$message')");
  //  print_r($query);die;
...
<body>
    ...
    <div class="container">
      <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
        <div class="col-md-7 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
          <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="index.php">Home</a></span> <span class="mr-2"><a href="blog.php">Blog</a></span> <span>Blog Details</span></p>
  ...
  <section class="ftco-section ftco-degree-bg">
    <div class="container">
      <div class="row">
        <?php
        $faculty = $usman_ngo->query("SELECT * FROM `blog` WHERE `id`= '{$blog_id}'");
        $row = $faculty->fetch_array();
        ?>
        <div class="col-md-8 ftco-animate">
          <h2 class="text-dark mb-3"><a href="#"><?php echo ucwords($row['header']) ?></h2>

          <p>
            <img src="./images/<?php echo ($row['image']) ?>" alt="" class="img-fluid">
          </p>
          <p><a class="text-dark" href="#"><?php echo ucwords($row['description']) ?></p>



          <div class="pt-5 mt-5">
            <?php
            $result = $usman_ngo->query("SELECT COUNT(*) FROM `blog_comment` WHERE `blog_id`= $blog_id");
            ...
            <ul class="comment-list">
              <?php
              $comments = $usman_ngo->query("SELECT * FROM `blog_comment` WHERE `blog_id`= '{$blog_id}'");
            ...
            <div class="form-group">
              <form action="#" method="post" class="p-5 bg-light">
                <input type="hidden" name="project_id" value="<?php echo $blog_id ?>">
